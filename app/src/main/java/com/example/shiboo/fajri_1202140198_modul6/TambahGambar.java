            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            com.example.shiboo.fajri_1202140198_modul6.ImageUpload imageUploadInfo = new com.example.shiboo.fajri_1202140198_modul6.ImageUpload(TempImageName, taskSnapshot.getDownloadUrl().toString());
